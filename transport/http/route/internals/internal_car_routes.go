...
func Car(internalRoute *mux.Router, app container.AppContainer) {
	...
	internalCarRoutes.HandleFunc("/{car_id}", internalcarcontroller.FindByIDWithFuelSummary(app.Services.Car)).Methods(http.MethodGet).Name("internalcarcontroller.FindByID")
